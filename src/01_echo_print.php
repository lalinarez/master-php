...
# El uso de las comillas simples es para no gastar tantos recursos al momento de ejecutar

# Para imprimir existe echo y print, pero la primera opción es mucho mejor en cuanto a rendimiento y funcionalidad

# Puede hacer más de una salida separando por coma los argumentos
...
# Solamente hace una salida
# Devuelve el valor de 1 cuando logra su cometido | int
print '<h1>Hola mundo desde PHP ' . PHP_VERSION . '</h1>';